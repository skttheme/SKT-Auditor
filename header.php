...
<?php esc_html_e( 'Skip to content', 'skt-auditor' ); ?>
</a>
<?php
	...
	$headerphonenumber = esc_html(get_theme_mod('header_phonenumber'));
	$hideheaderphone = esc_html(get_theme_mod('hide_header_phone', 1));	
	$inner_header_trans = esc_html(get_theme_mod('option_inner_header_transparent', 1));
?>
<div id="main-set">

<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}elseif(!is_home() && !is_front_page() && $inner_header_trans == '') {echo esc_html('transheader');}?>">
	<div class="container">
    <div class="logo">
		<?php skt_auditor_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
        ...
        <div id="navigation" <?php if( $hideheaderphone !== '') { ?>class="leftnavig"<?php } ?>><nav id="site-navigation" class="main-navigation">
            ...
            <div class="srcrt">
                <div class="header-content-right">
                    <div class="skt-header-extras">
                    	<div class="skt-header-button"><div class="hedbtn-details"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/phone-icon.png" /><?php echo esc_html( $headerphonenumber ); ?></div></div>
                    </div>
                </div>
            </div>
            <?php } ?>
